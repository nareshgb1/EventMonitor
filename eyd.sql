...
col host_name for a10 head host
...
where h.begin_interval_time between trunc(sysdate-1) - 1.1/24 and trunc(sysdate)
...
) where prev_waits is not null and waits_delta > 0
order by event_name
	, snap_id
/
